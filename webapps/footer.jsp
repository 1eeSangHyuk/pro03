	...
	<div class="container is-fullhd">
		<div class="content has-text-centered">
			...
			<a href="https://youtube.com/BTOrganization">
				<img src="${footer_path }/img/index/sns5.png" alt="">
			</a>
			<a href="https://www.facebook.com/visitbusan.kr">
				<img src="${footer_path }/img/index/sns2.png" alt="">
			</a>
			<a href="https://www.instagram.com/visitbusan.kr">
				<img src="${footer_path }/img/index/sns3.png" alt="">
			</a>
		...
		<div class="tile is-ancestor">
			...
			<div id="ftBox" class="tile is-parent">
				<article id="ftBox1" class="tile is-child box">
					<h3 class="cat title is-4">유용한정보</h3>
					<ul>
						<li><a href="">공지사항</a></li>
          				<li><a href="">랭킹</a></li>
          				<li><a href="">QnA</a></li>
		...
		<div class="tile is-ancestor">
			<div class="tile is-parent">
				<article id="ftBox2" class="tile is-child box">
					...
					<figure class="image is-128x128">
						<img src="${footer_path }/img/index/footer1.png" alt="footer1">
					</figure>
			...
			<div class="tile is-parent">
				<article id="ftBox2" class="tile is-child box">
					...
					<figure class="image is-128x128">
						<img src="${footer_path }/img/index/footer2.png" alt="footer2">
					</figure>
					<figure class="image is-128x128">
						<img src="${footer_path }/img/index/footer2.5.png" alt="footer2.5">
					</figure>
				</article>
			</div>
			<div class="tile is-parent">
				<article id="ftBox2" class="tile is-child box">
					...
					<figure class="image is-128x128">
						<img src="${footer_path }/img/index/footer3.png" alt="footer3">
					</figure>
					<div class="content">
						<p>평일 08:30 - 18:30</p>
